...
class Shadowing2 : public Propagation {
public:
	Shadowing2();
	~Shadowing2();
...
protected:
	...
	double pathlossExp1_;	// path-loss exponent1
	double pathlossExp2_;	// path-loss exponent2
	double std_db1_;		// shadowing deviation (dB),
	double std_db2_;		// shadowing deviation (dB),
	double dist0_;	// close-in reference distance
	double dist1_; // inflexion distance
