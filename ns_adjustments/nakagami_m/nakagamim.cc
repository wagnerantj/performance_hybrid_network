...
static class NakagamimClass: public TclClass {
public: 
	NakagamimClass() : TclClass("Propagation/Nakagamim") {}
	TclObject* create(int, const char*const*) {
		return (new Nakagamim);	
}
} class_nakagamim;
...
Nakagamim::Nakagamim(double g0,double g1,double g2,double d0_g,double d1_g,double m_0,double m_1,double m_2,double m_3,double m_4,double m_5,double d0m,double d1m,double d2m,double d3m,double d4m, int use_distribution)
{
	gamma0 =g0;
	gamma1 =g1;
	gamma2 =g2;
...
double Nakagamim::Pr(PacketStamp *t, PacketStamp *r, WirelessPhy *ifp)
{
    ...
    // calculate the receiving power at distance dist
 	...
 	if (!use_nakagami_dist_) {
        ...
        cout<<dist<<", "<<resultPower<<endl;
 		return resultPower;
	}
}	

int Nakagamim::command(int , const char* const* )
{
	return 0;
}


double Nakagamim::getDist(double , double , double , double , double , double , double , double ) {
	return DBL_MAX;
}
