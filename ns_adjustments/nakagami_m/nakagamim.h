...
class Nakagamim : public Propagation {
public:
	Nakagamim();
	Nakagamim(double g0,double g1,double g2,double d0_g,double d1_g,double m_0,double m_1,double m_2,double m_3,double m_4,double m_5,double d0m,double d1m,double d2m,double d3m,double d4m, int use_distribution);
	~Nakagamim();
...
protected:
	...
	double d0_m,d1_m,d2_m,d3_m,d4_m;
};
