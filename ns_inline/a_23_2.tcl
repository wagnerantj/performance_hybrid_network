...
#set send_time  [expr 10.0*$j+10]
set con_id [expr $j*10]
set send_time  [expr 10*$j]
set udp_($con_id) [new Agent/UDP]
$ns_ attach-agent $node_(5) $udp_($con_id)
set null_($con_id) [new Agent/Null]
$ns_ attach-agent $node_(11) $null_($con_id)
