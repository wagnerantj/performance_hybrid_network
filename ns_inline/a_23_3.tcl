...
for {set j 0} {$j < 54 } { incr j } { 
set con_id [expr $j]
set send_time  [expr 10*$j]
set udp_($con_id) [new Agent/UDP]
$ns_ attach-agent $node_(4) $udp_($con_id)
set null_($con_id) [new Agent/Null]
$ns_ attach-agent $node_(9) $null_($con_id)
